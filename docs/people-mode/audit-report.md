...
[fatigue-analysis.md](./fatigue-analysis.md). Treat as a **calibration** issue,
...
[utilization-analysis.md](./utilization-analysis.md) §Edge cases.
...
meaningful at week-or-longer ranges. See [utilization-analysis.md](./utilization-analysis.md).
