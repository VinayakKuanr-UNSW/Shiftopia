...
2. [03-utilization-analysis.md](./03-utilization-analysis.md) and [02-fatigue-analysis.md](./02-fatigue-analysis.md) — the two numbers everyone asks about.
3. [01-audit-report.md](./01-audit-report.md) — what's actually broken, ranked.
4. [04-ui-review.md](./04-ui-review.md) — every element on the row/card.
5. [05-technical-debt.md](./05-technical-debt.md) — cleanup & perf backlog.
</invoke>
