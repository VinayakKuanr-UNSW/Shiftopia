...
with the correctness fixes in [01-audit-report.md](./01-audit-report.md) where noted.
...
- No unit tests found for `computePeakFatigue` / `computeUtilizationPct` /
  ...
  [02-fatigue-analysis.md](./02-fatigue-analysis.md) and
  [03-utilization-analysis.md](./03-utilization-analysis.md) — cheap, high-value to lock
