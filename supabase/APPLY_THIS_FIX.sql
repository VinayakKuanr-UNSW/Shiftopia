-- Quick Fix SQL: Apply directly in Supabase SQL Editor
-- This updates the cancel_shift_v2 function to:
-- 1. Enforce 4-hour cancellation rule
-- 2. Populate direct shift columns for bidding page display
