-- Migration: Fix apply_monthly_template Past Shifts
-- Date: 2026-02-05
-- Purpose: Prevent creating shifts that are already in the past when applying template to the current day.
