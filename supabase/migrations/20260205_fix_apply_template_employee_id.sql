-- Migration: Fix apply_monthly_template column error
-- Date: 2026-02-05
-- Purpose: Remove reference to deprecated 'employee_id' column in shifts table insert.
-- The column 'assigned_employee_id' is the correct one to use.
