-- Migration: Fix delete_shift_cascade
-- Date: 2026-02-05
-- Purpose: Remove insert to missing shift_audit_log table. Use trigger for audit.
...
EXCEPTION WHEN OTHERS THEN
    -- Log error but don't silently return false without detail in logs (though RPC error is swallowed by frontend currently)
