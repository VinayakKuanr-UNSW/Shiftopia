-- Migration: Restore SECURITY DEFINER to template RPCs
-- Date: 2026-02-20
-- The previous migration removing is_draft accidentally stripped the SECURITY DEFINER. This adds it back.
