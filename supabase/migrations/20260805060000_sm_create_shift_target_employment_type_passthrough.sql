-- Migration: 20260805060000_sm_create_shift_target_employment_type_passthrough.sql
-- Description: Teaches `sm_create_shift` to persist `target_employment_type` and
