-- Migration: Fix apply_monthly_template to insert into SHIFTS table
-- Date: 2026-01-09
-- Purpose: Rewrite apply_monthly_template to:
--   1. Create roster entries in rosters table
--   2. Extract shifts from template and insert into shifts table
--   3. This ensures RostersPlannerPage can display the shifts
