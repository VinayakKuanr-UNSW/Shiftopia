...
import { V8OrchestratorInput, any, V8OrchestratorResult, EvaluationCacheEntryV2 } from './types';
...
/**
 * Builds a stable, order-independent cache key from V8OrchestratorInput.
 *
 ...
 */
export function buildCacheKey(input: V8OrchestratorInput): string {
 ...
 */
export function getAffectedRules(changes: any): string[] {
...
export class EvaluationCache {
    ...
    get(key: string): V8OrchestratorResult | null {
