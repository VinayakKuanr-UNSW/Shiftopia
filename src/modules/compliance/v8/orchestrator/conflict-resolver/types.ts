...
export type ConflictV8OperationType = 'ASSIGN' | 'BID_ACCEPT' | 'SWAP_APPROVE';
...
export interface ConflictResolverBaseState {
    ...
    employee_existing_shifts: { employee_id: V8EmpId; shifts: V8OrchestratorShift[] }[];
    /**
...
export interface ScoredOperation {
    ...
    pre_compliance_status: V8Status;    // standalone compliance status
}
