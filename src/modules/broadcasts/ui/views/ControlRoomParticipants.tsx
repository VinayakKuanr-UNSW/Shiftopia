...
export const ControlRoomParticipants: React.FC<ControlRoomParticipantsProps> = ({
    ...
    return (
        <div
            className={cn(
                "bg-card border-l border-border flex flex-col shrink-0 transition-all duration-300 overflow-hidden",
                isOpen ? "w-80 translate-x-0 opacity-100" : "w-0 opacity-0 translate-x-10"
            )}
        >
            <div className="p-5 border-b border-border min-w-[20rem]">
                ...
                {canManage && (
                    <div className="space-y-2">
                        ...
                        >
                            <UserMinus className="h-4 w-4 mr-2 rotate-90" />
                            Add Participants
                        </Button>
                        <Button
                            variant="outline"
