...
const ProfilePage: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="show"
      className="w-full min-h-screen p-4 md:p-6 lg:p-8 space-y-8 pb-24 md:pb-8 bg-background"
    >
      {/* Profile Header Card */}
      <motion.div
        ...
        <div className="relative z-10 px-8 py-10 flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          <div className="flex-1 text-center md:text-left space-y-2 pt-2">
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-4">
              <div>
                <h1 className="text-3xl font-black tracking-tight text-foreground">{user?.firstName} {user?.lastName}</h1>
            ...
            {/* Quick Stats Row */}
            <div className="flex items-center justify-center md:justify-start gap-8 mt-6 pt-6 border-t border-border">
      ...
      {/* CONTENT SECTION */}
      <motion.div variants={itemVariants} className="bg-card border border-border rounded-2xl shadow-sm">
