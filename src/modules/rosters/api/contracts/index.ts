...
// sm_create_shift / sm_update_shift → returns the full shift row
export const CreateShiftResponseSchema = ShiftCoreSchema;
export const UpdateShiftResponseSchema = ShiftCoreSchema;
