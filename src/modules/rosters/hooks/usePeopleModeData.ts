        ...
        shifts.forEach((shift) => {
            ...
            if (shift.assigned_employee_id) {
                ...
                const viewShift: PeopleModeShift = {
                    ...
                    status: shift.is_draft ? 'Draft' : 'Assigned',
